...
namespace VehiclesApi.Controllers
{
    ...
    public class OwnersController : ControllerBase
    {
        ...
        // GET: api/Owners
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Owner>>> GetOwnerItems()
        {
            return await _context.OwnerItems.ToListAsync();
        }
        ...
        {
            var owner = await _context.OwnerItems.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteOwner(long id)
        {
            ...
            _context.OwnerItems.Remove(owner);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.OwnerItems.Any(e => e.Id == id);
        }
    }
}
